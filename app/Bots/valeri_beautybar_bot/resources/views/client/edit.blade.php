        ...
        <div class="w-full space-y-3 sm:flex sm:space-x-3 sm:space-y-0">
            <div class="w-full">
                <x-telegram::white-block>
                    <form method="post" action="{{ route('valeri_beautybar_bot.client.update', $client) }}" >
                        @csrf
                        @method('patch')
            ...
            <div class="w-full space-y-3">
                @if (auth()->user()->isAdmin())
                    <x-telegram::white-block>
                        <form action="{{ route('valeri_beautybar_bot.client.edit', $client ) }}" id="userForm">
                            <div class="">
                ...
                <x-telegram::white-block>
                    <form method="post" action="{{ route('valeri_beautybar_bot.appointment.store') }}">
                        @csrf
                        @method('post')
