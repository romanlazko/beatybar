<x-telegram::layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <x-telegram::a-buttons.secondary href="{{ route('valeri_beautybar_bot.client.create') }}" >
                {{ __("+ Add client") }}
                ...
                <x-telegram::table.tbody>
                    @forelse ($clients as $index => $client)
                        <tr class="@if($index % 2 === 0) bg-gray-100 @endif text-sm">
                            ...
                            <x-telegram::table.td>
                                <a class="hover:underline" href="{{ route('valeri_beautybar_bot.client.edit', $client) }}">
