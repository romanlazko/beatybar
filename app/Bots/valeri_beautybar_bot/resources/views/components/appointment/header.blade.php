<div class="space-y-2">
    ...
    <div class="w-full">
        <a href="{{ route('valeri_beautybar_bot.client.edit' , $appointment->client) }}" class="font-bold text-lg hover:underline">{{ $appointment->client?->first_name }} {{ $appointment->client?->last_name }}</a>
