<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        {{-- Chat ID --}}
        <input type="hidden" name="telegram_chat_id" value="{{old('telegram_chat_id', request()->telegram_chat_id)}}" required/>
    ...
    @if (isset($errors) AND $errors->any())
        <x-telegram::notifications.small class="bg-red-500" :title="implode('\n', $errors->all())"/>
    @endif
</x-guest-layout>
